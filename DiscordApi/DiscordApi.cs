namespace DiscordApi
{
    ...
    public class DiscordApi
    {
        ...
        public Task SendMessageAsync(ulong channel, string username, string message, bool bypassLock = false)
        {
            ...
            string messageToSend = $"`[{now}]` **{username}:** {message}";
            return this.SendMessageAsync(channel, messageToSend, bypassLock);
        }
        public Task SendCustomMessage(ulong channel, string message, bool bypassLock = false)
        {
            return this.SendMessageAsync(channel, message, bypassLock);
        }
        ...
        public async Task StartAsync(string token)
        {
            ...
            client.Disconnected += _ => { Environment.Exit(-1); return Task.CompletedTask; };
        }
